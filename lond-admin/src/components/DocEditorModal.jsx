...
export default function DocEditorModal({ show, onClose, templateType, caseData, caseId, onSaved }) {
  ...
  const renderMgLoan = () => (
    <>
      ...
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        <b>2.2</b> "ผู้กู้" ตกลงและยินยอมทำประกันภัยทรัพย์สินตามที่ระบุข้างต้นไว้กับบริษัทประกันภัยที่ "ผู้ให้กู้" เห็นชอบ ในวงเงินไม่น้อยกว่าราคาประเมินตลาดของมูลค่าของสิ่งปลูกสร้างไม่รวมที่ดินตามสัญญาฉบับนี้ โดยให้ "ผู้ให้กู้" ตกลงจะชำระค่าเบี้ยประกันภัยให้แล้วเสร็จภายใน 15 วัน นับจากวันที่รับมอบเงินสินเชื่อตามสัญญาฉบับนี้หรือภายในเวลาที่ "ผู้ให้กู้" เป็นผู้ชำระเบี้ยประกันภัยและเสียค่าใช้จ่ายในเรื่องดังกล่าวแทน หาก "ผู้กู้" ข้อต่อสัญญาประกันภัยตลอดระยะเวลาที่ "ผู้กู้" เป็นหนี้ "ผู้ให้กู้"
      </p>
  ...
  const renderMgAddendum = () => (
    <>
      ...
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        ระหว่าง นาย/นาง/นางสาว {F('lender_first_name', 150, 'ชื่อผู้รับจำนอง')} เลขบัตรประชาชน {F('lender_id', 130)} เบอร์ {F('lender_phone', 100)} <b>"ผู้รับจำนอง"</b> กับ
      </p>
      ...
      {/* Section 3 - Interest Rate */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 3.</b> <b>"ผู้จำนอง"</b> ยอมเสียดอกเบี้ยให้แก่ <b>"ผู้รับจำนอง"</b> ในอัตราร้อยละ {F('interest_rate', 60, '%')} ต่อปี ในจำนวนเงินซึ่ง <b>"ลูกหนี้"</b> หากเลย ถ้า <b>"ผู้จำนอง"</b> หรือลูกหนี้ปฏิบัติผิดนัด หรือผิดสัญญา <b>"ผู้รับจำนอง"</b> ยอมเสียดอกเบี้ยในอัตราร้อยละ {F('late_interest_rate', 60, '%')} ต่อปี...
      </p>
      ...
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 8.</b> ในระหว่างที่ทรัพย์จำนองนี้อยู่ในการจำนองตามสัญญานี้ "ผู้จำนอง" จะให้สิทธิประการใดแก่บุคคลอื่นเหนือทรัพย์ที่จำนอง เช่น สิทธิการเช่า สิทธิอาศัย สิทธิครอบครอง หรือสิทธิในการก่อสร้าง ให้ทางเดิน ให้ยืม สิทธิเหนือพื้นดิน สิทธิเก็บกิน เป็นต้น และภาระจำยอมอื่นๆ อันอาจเป็นการเสื่อมเสียสิทธิ รอนสิทธิ หรือตัดสิทธิของ "ผู้รับจำนอง" "ผู้จำนอง" ต้องได้รับความยินยอมและอนุญาตเป็นลายลักษณ์อักษรจาก "ผู้รับจำนอง" ก่อน
      </p>
