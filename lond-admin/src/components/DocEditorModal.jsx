...
export default function DocEditorModal({ show, onClose, templateType, caseData, caseId, onSaved }) {
  ...
  const renderSpContract = () => (
    <>
      ...
      <p style={{ ...S, textAlign: 'right', fontSize: 'inherit' }}>
        ทำที่ บริษัท โลนด์ ดีดี จำกัด 87 ถนนสุวินทวงศ์<br />แขวงมีนบุรี เขตมีนบุรี กรุงเทพฯ 10510
      </p>
      <p style={{ ...S, textAlign: 'right', fontSize: 'inherit' }}>
        วันที่ {F('contract_date', 160, 'วัน เดือน ปี')}
      </p>
      ...
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 1.</b> ผู้ขายฝากตกลงขายฝาก และผู้ซื้อฝากตกลงซื้อฝาก{F('property_type_full', 180, 'ห้องชุด/ที่ดินเปล่า/ที่ดินพร้อมสิ่งปลูกสร้าง')} เลขที่{F('address_no', 80)} โฉนดเลขที่{F('deed_no', 100)} เลขที่ดิน{F('land_no', 80)} หน้าสำรวจ{F('survey_page', 80)} ตำบล{F('tambon', 100)} อำเภอ{F('amphoe', 100)} จังหวัด{F('province', 100)} เนื้อที่รวม {F('land_area', 130, 'ไร่/งาน/ตารางวา/ตารางเมตร')} โดยผู้ขายฝากรับรองว่า ผู้ขายฝากเป็นเจ้าของผู้มีกรรมสิทธิ์และมีสิทธิโดยชอบด้วยกฎหมายแต่เพียงผู้เดียวในการเข้าทำสัญญานี้และขายฝากทรัพย์สินที่ขายฝากได้ โดยปราศจากการโต้แย้งและการรอนสิทธิใด ๆ ทั้งสิ้น รวมถึงไม่ติดค้างชำระค่าภาษีอากร ค่าธรรมเนียมใด ๆ และรวมถึงไม่ติดค้างค่าสาธารณูปโภคใด ๆ อันเกี่ยวกับทรัพย์สินที่ขายฝากทั้งสิ้น และผู้ขายฝากไม่ได้อยู่ในระหว่างการพิจารณาคดีหย้าร้างอันมีทรัพย์สินที่ขายฝากเป็นสินสมรส และไม่ได้เป็นหรือจะเป็นบุคคลล้มละลาย หรือเป็นผู้มีหนี้สินล้นพ้นตัวตามกฎหมาย และไม่เคยถูกศาลสั่งพิทักษ์ทรัพย์ในคดีล้มละลายมาก่อน หรือถูกฟ้องเป็นคดีล้มละลาย โดยผู้ขายฝากขอรับรองว่าการทำสัญญานี้สมบูรณ์ชอบด้วยกฎหมายทุกประการ และจะไม่มีการเพิกถอนนิติกรรมในภายหลัง ไม่ว่าจะกรณีใด ๆ
      </p>
      ...
      {(selectedVersion === 5) ? (
        ...
        <p style={{ ...S, fontSize: 'inherit' }}>
          <b>3.1.</b> หากผู้ขายฝากต้องการไถ่ถอนทรัพย์สินที่ขายฝากก่อนครบกำหนดระยะเวลาตามสัญญาฉบับนี้ ภายในระยะเวลา 6 เดือน ผู้ขายฝากตกลงและยินยอมชำระค่าสินไถ่ให้แก่ผู้ซื้อฝากตามข้อ 3. และผู้ซื้อฝากยินยอมคืนสินไถ่ที่ได้ชำระมาตามข้อ 2. เป็นจำนวนเงิน {F('early_refund_amount', 130)} บาท ({F('early_refund_text', 150)})
        </p>
      ) : (
        <p style={{ ...S, fontSize: 'inherit' }}>
      ...
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 7.</b> ผู้ขายฝากทราบดีว่าผู้ซื้อฝากอาจเปิดเผยข้อมูลใด ๆ ที่ผู้ขายฝากได้ให้ไว้แก่ผู้ซื้อฝาก และ/หรือข้อมูลที่เกี่ยวข้องกับผู้ขายฝาก (ซึ่งไม่ใช่ข้อมูลที่ได้รับจากบริษัทข้อมูลเครดิต) เท่าที่จำเป็นต่อบริษัทในเครือของผู้ขายฝาก รวมถึงกรรมการ และลูกจ้างของผู้ขายฝาก เพื่อวัตถุประสงค์ในการจัดเก็บข้อมูล บริหาร วิเคราะห์ตรวจสอบ ทบทวน และป้องกันความเสี่ยงด้านสินเชื่อ ซึ่งเป็นการประมวลผลข้อมูลส่วนบุคคลบนฐานประโยชน์อันชอบธรรม
      </p>
      ...
      {/* Section 8 - Notices */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 8.</b> บรรดาหนังสือ จดหมายติดต่อ คำบอกกล่าวใดๆ ที่ผู้ซื้อฝากได้ส่งให้ผู้ขายฝากตามที่อยู่ที่แจ้งไว้ตามสัญญาฉบับนี้ ไม่ว่าจะโดยส่งเองหรือส่งทางไปรษณีย์ลงทะเบียน หรือไม่ลงทะเบียน ให้ถือว่าได้ส่งให้แก่ผู้ขายฝากแล้วโดยชอบ ทั้งนี้ โดยไม่ต้องคำนึงถึงว่าจะมีผู้รับไว้หรือไม่ และแม้หากส่งให้ไม่ได้เพราะย้ายที่อยู่ หรือที่อยู่เปลี่ยนแปลงไป หรือถูกรื้อถอนไปโดยมิได้มีการแจ้งการย้าย การเปลี่ยนแปลง หรือการรื้อถอนนั้นเป็นลายลักษณ์อักษรให้ผู้ซื้อฝากทราบก็ดี หรือส่งให้ไม่ได้เพราะหาที่อยู่ตามที่ระบุไว้นั้นไม่พบก็ดี ให้ถือว่าผู้ขายฝากได้รับและทราบหนังสือ จดหมาย หรือคำบอกกล่าวดังกล่าวแล้วโดยชอบ
      </p>

      {/* Section 9 - Waiver */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 9.</b> การล่าช้าหรือการไม่ใช้สิทธิใด ๆ ของผู้ซื้อฝากตามข้อกำหนดหรือเงื่อนไขใด ๆ ของสัญญานี้หรือตามกฎหมาย ไม่ถือว่าผู้ซื้อฝากสละสิทธิหรือให้ความยินยอมในการดำเนินการใด ๆ ตามที่ผู้ซื้อฝากมีสิทธิแก่ผู้ขายฝากแต่ประการใด เว้นแต่ผู้ซื้อฝากจะได้ทำเป็นหนังสืออย่างชัดแจ้งและการสละสิทธิเช่นว่านั้นให้มีผลเฉพาะสำหรับเหตุการณ์และวัตถุประสงค์นั้นเท่านั้น
      </p>

      {/* Section 10 - Severability */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 10.</b> คู่สัญญาตกลงว่า ในกรณีที่ข้อความข้อกำหนดหรือเงื่อนไขใด ๆ ในสัญญาฉบับนี้ไม่สมบูรณ์ หรือเป็นโมฆะ หรือขัดต่อกฎหมาย หรือไม่ชอบด้วยกฎหมาย หรือใช้บังคับไม่ได้ตามกฎหมาย ให้ส่วนอื่นๆ ของข้อกำหนดและเงื่อนไขของสัญญาฉบับนี้ยังคงมีผลสมบูรณ์ชอบด้วยกฎหมาย และใช้บังคับได้ตามกฎหมาย และไม่ถูกกระทบหรือเสื่อมเสียไปเพราะความไม่สมบูรณ์ เป็นโมฆะ ขัดต่อกฎหมาย ไม่ชอบด้วยกฎหมาย หรือใช้บังคับไม่ได้ตามกฎหมายของข้อความข้อกำหนด หรือเงื่อนไขดังกล่าวนั้น
      </p>

      {/* Closing Statement */}
      <p style={{ ...S, fontSize: 'inherit', marginTop: 16 }}>
        สัญญานี้ทำขึ้นเป็นสองฉบับ มีข้อความถูกต้องตรงกัน คู่สัญญาทั้งสองฝ่ายได้อ่านและเข้าใจข้อความในสัญญาโดยตลอดแล้ว เพื่อเป็นหลักฐานคู่สัญญาจึงลงลายมือชื่อไว้เป็นสำคัญต่อหน้าพยาน ณ วันเดือนปีที่ระบุไว้ข้างต้น และต่างยึดถือไว้ฝ่ายละฉบับ
      </p>
  ...
  const renderSpBroker = () => (
    <>
      ...
      <p style={{ ...S, textAlign: 'right', fontSize: 'inherit' }}>
        วันที่ {F('contract_date', 150, 'วัน เดือน ปี')}
      </p>

      {/* Parties - Company (Broker) */}
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        ระหว่าง บริษัท โลนด์ ดีดี จำกัด ทะเบียนนิติบุคคลเลขที่ {F('company_id', 130, '0105566225836')} โดย นาย {F('company_officer', 120, 'วรวุฒิ กิตดิอุดม')} กรรมการผู้มีอำนาจ สำนักงานตั้งอยู่เลขที่ 87 ถนนสุวินทวงศ์ แขวงมีนบุรี เขตมีนบุรี กรุงเทพมหานคร โทรศัพท์ {F('company_phone', 100, '081-6386966')} ซึ่งต่อไปในสัญญานี้จะเรียกว่า <b>"นายหน้า"</b> ฝ่ายหนึ่ง กับ
      </p>

      {/* Parties - Client (Property Owner) — version-conditional */}
      {selectedVersion === 3 ? (
        <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
          บจก./หจก. {F('seller_company', 200)} ทะเบียนนิติบุคคลเลขที่ {F('seller_reg_id', 130)} โดย {F('seller_name', 120)} กรรมการผู้มีอำนาจ ที่อยู่บริษัท {F('seller_address', 250)} เบอร์ {F('seller_phone', 100)} ซึ่งต่อไปในสัญญานี้จะเรียกว่า <b>"ผู้ให้สัญญา"</b> รหัสทรัพย์ {F('property_code', 100)} อีกฝ่ายหนึ่ง
        </p>
      ) : selectedVersion === 2 ? (
        <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
          นาย/นาง/นางสาว {F('seller_name', 150)} เลขบัตรประชาชน {F('seller_id', 130)} ที่อยู่ตามบัตร {F('seller_address', 250)} และ นาย/นาง/นางสาว {F('seller_name2', 150)} เลขบัตรประชาชน {F('seller_id2', 130)} ที่อยู่ตามบัตร {F('seller_address2', 250)} เบอร์ {F('seller_phone', 100)} ซึ่งต่อไปในสัญญานี้จะเรียกว่า <b>"ผู้ให้สัญญา"</b> รหัสทรัพย์ {F('property_code', 100)} อีกฝ่ายหนึ่ง
        </p>
      ) : (
        <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        ...
        <div style={{ textAlign: 'center', width: '45%' }}>
          {selectedVersion === 3 ? (
            <>
              ...
              <div style={{ marginTop: 12, fontSize: 'inherit' }}>บจก./หจก. {F('seller_company', 150)}</div>
              <div style={{ marginTop: 8, fontSize: 'inherit' }}>( {F('seller_name', 150)} )</div>
            </>
          ) : selectedVersion === 2 ? (
            <>
              <div style={{ fontSize: 'inherit' }}>ลงชื่อ......................................ผู้ให้สัญญา</div>
              ...
              <div style={{ marginTop: 20, fontSize: 'inherit' }}>( {F('seller_name2', 150)} )</div>
            </>
          ) : (
            <>
              <div style={{ fontSize: 'inherit' }}>ลงชื่อ......................................ผู้ให้สัญญา</div>
  ...
  const renderSpAppendix = () => (
    <>
      ...
      {selectedVersion >= 2 ? (
        <p style={{ ...S, fontSize: 'inherit', marginBottom: 14 }}>
          ตามที่ นาย/นาง/นางสาว {F('seller_name', 150)} เลขบัตรประชาชน {F('seller_id', 130)} ที่อยู่ตามบัตร {F('seller_address', 250)} และ นาย/นาง/นางสาว {F('seller_name2', 150)} เลขบัตรประชาชน {F('seller_id2', 130)} ที่อยู่ตามบัตร {F('seller_address2', 250)} เบอร์ {F('seller_phone', 100)} <b>"ผู้ให้สัญญา"</b>
        </p>
      ) : (
        <p style={{ ...S, fontSize: 'inherit', marginBottom: 14 }}>
      ...
      <p style={{ ...S, fontSize: 'inherit', marginBottom: 14 }}>
        ได้ตกลงทำสัญญาแต่งตั้งนายหน้าขายฝาก ฉบับลงวันที่ {F('main_contract_date', 150)} กับ <b>บริษัท โลนด์ ดีดี จำกัด ("นายหน้า")</b> ทะเบียนนิติบุคคลเลขที่ {F('company_id', 130, '0105566225836')} โดย นาย {F('company_officer', 120, 'วรวุฒิ กิตดิอุดม')} กรรมการผู้มีอำนาจ สำนักงานตั้งอยู่เลขที่ 87 ถนนสุวินทวงศ์ แขวงมีนบุรี เขตมีนบุรี กรุงเทพมหานคร โทรศัพท์ {F('company_phone', 100, '081-6386966')}
      </p>

      {/* Property Transaction — one paragraph as per PDF */}
      <p style={{ ...S, fontSize: 'inherit', marginBottom: 14 }}>
        บัดนี้ ข้าพเจ้าผู้ให้สัญญาได้เข้าทำสัญญากับนายทุนผู้รับซื้อฝาก <b>{F('property_type_full', 180, 'ห้องชุด/ที่ดินเปล่า/ที่ดินพร้อมสิ่งปลูกสร้าง')}</b> เลขที่ {F('address_no', 80)} โฉนดเลขที่ {F('deed_no', 100)} เลขที่ดิน {F('land_no', 80)} หน้าสำรวจ {F('survey_page', 80)} ตำบล {F('tambon', 100)} อำเภอ {F('amphoe', 100)} จังหวัด {F('province', 100)} เนื้อที่รวม {F('land_area', 130, 'ไร่/งาน/ตารางวา/ตารางเมตร')} <b>กำหนดเวลาไถ่คืนภายใน 1 ปี</b> และกำหนดสินไถ่ได้ว่าเป็นเงิน {F('redemption_price', 130)} บาท ({F('redemption_price_text', 220)}) และมี<b>ค่าบริการเพิ่มเติม</b>จำนวน {F('additional_fee', 100)}
      </p>

      {/* Registration + Closing — same paragraph as per PDF */}
      <p style={{ ...S, fontSize: 'inherit', marginBottom: 14 }}>
        โดยได้จดทะเบียนกับกรมที่ดินแล้วเมื่อวันที่ {F('registration_date', 150)} ดังนั้น ผู้ให้สัญญาจึงได้ลงนามเอกสารแนบท้ายสัญญาแต่งตั้งนายหน้าขายฝากฉบับนี้ เพื่อให้เป็นไปตามเงื่อนไขของสัญญาแต่งตั้งนายหน้าขายฝากฉบับวันที่ {F('original_contract_date', 150)}
      </p>
  ...
  const renderMgLoan = () => (
    <>
      ...
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 2.</b> "ผู้กู้" ตกลงให้ "ผู้ให้กู้" ส่งมอบเงินสินเชื่อให้แก่ "ผู้กู้" เมื่อได้จดทะเบียนจำนอง <b>{F('property_type_full', 120)}</b> เลขที่{F('address_no', 80)} โฉนดเลขที่{F('deed_no', 80)} เลขที่ดิน {F('land_no', 60)} หน้าสำรวจ {F('survey_page', 60)} ตำบล {F('tambon', 80)} อำเภอ {F('amphoe', 80)} จังหวัด {F('province', 100)} เนื้อที่รวม {F('land_area', 100)} เรียบร้อยแล้ว เว้นแต่จะได้รับความยินยอมจาก "ผู้ให้กู้" เป็นอย่างอื่น
      </p>

      {/* Section 2.1 - Security */}
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        <b>2.1</b> "ผู้กู้" ตกลงและยินยอมให้บรรดาทรัพย์สินที่ "ผู้กู้" ได้มอบไว้เป็นหลักประกันตามที่ระบุข้างต้นนั้น ให้ถือเป็นหลักประกันหนี้ และ/หรือภาระใด ๆ ทั้งหมดของ "ผู้กู้" ที่มีต่อ "ผู้ให้กู้" ทั้งที่มีอยู่แล้วในขณะนี้ และ/หรือจะมีต่อไปในภายหน้า
      </p>
      ...
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        ในกรณีที่ "ผู้กู้" ต้องการขอขยายระยะเวลาชำระคืนเงินสินเชื่อ "ผู้กู้" ตกลงชำระดอกเบี้ยล่วงหน้าตามระยะเวลาที่ขอขยายในวันที่ครบกำหนดชำระคืน หาก "ผู้กู้" ฝ่าฝืนไม่ชำระดอกเบี้ยล่วงหน้าตามข้อตกลงนี้ ให้ถือว่า "ผู้กู้" ผิดนัดชำระหนี้และ "ผู้ให้กู้" จะดำเนินคดีตามกฎหมายต่อไป
      </p>

      {/* Section 5 - Default and Penalties */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 5.</b> หากเกิดเหตุการณ์ใดเหตุการณ์หนึ่ง ดังจะกล่าวต่อไปนี้ "ผู้กู้" ยินยอมให้ "ผู้ให้กู้" มีสิทธิที่จะถือว่าเป็นกรณี "ผู้กู้" ผิดนัดชำระหนี้ และให้ถือว่าหนี้ถึงกำหนดชำระทันที "ผู้กู้" ตกลงและยินยอมให้ "ผู้ให้กู้" คิดดอกเบี้ยจากเงินที่ค้างชำระทั้งหมดในอัตราร้อยละ 20 (ยี่สิบ) ต่อปีนับแต่วันที่ "ผู้กู้" ตกเป็นผู้ผิดนัดชำระหนี้จนกว่าจะชำระหนี้ครบถ้วน พร้อมด้วยค่าเสียหายและค่าใช้จ่ายทั้งหลายอันเนื่องจากการผิดนัดชำระหนี้ของ "ผู้กู้" รวมทั้งค่าใช้จ่ายในการเตือน เรียกร้อง ทวงถาม ดำเนินคดี และบังคับชำระหนี้จนเสร็จ ในกรณีดังต่อไปนี้
      </p>
      ...
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        <b>5.3</b> "ผู้กู้" ไม่ปฏิบัติตามสัญญาฉบับนี้ ไม่ว่าข้อหนึ่งข้อใด ตลอดจนคำรับรองหรือคำยืนยันใด ๆ ที่ "ผู้กู้" ให้ไว้ตามสัญญานี้เป็นคำรับรองหรือคำยืนยันที่ไม่เป็นความจริง หรือพิสูจน์ได้ว่าไม่เป็นความจริง ไม่ถูกต้อง หรืออาจจะก่อให้เกิดความเข้าใจผิดในสาระสำคัญ
      </p>

      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        <b>5.4</b> "ผู้ให้กู้" ได้พิจารณาแล้วเห็นว่ามีการเปลี่ยนแปลงทางฐานะการเงินหรือรายได้ของ "ผู้กู้" ซึ่งเป็นสาระสำคัญอันมีผลกระทบต่อความสามารถในการชำระหนี้ของ "ผู้กู้"
      </p>

      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        <b>5.5</b> "ผู้กู้" เสียชีวิต หรือตกเป็นผู้ไร้ความสามารถ หรือเป็นบุคคลผู้มีหนี้สินล้นพ้นตัว หรือถูกพิทักษ์ทรัพย์ หรือถูกอายัดทรัพย์ หรือทำการโอนสิทธิเพื่อประโยชน์ของเจ้าหนี้ของตน หรือมีการดำเนินคดีใด ๆ หรือมีการขอให้ออกคำสั่งอย่างใดๆ เพื่อการล้มละลาย การปรับปรุงโครงสร้างหนี้ใหม่
      </p>

      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        <b>5.6</b> เจ้าของหลักประกันที่ให้ไว้เป็นประกันการชำระหนี้ตามสัญญานี้ ขอชำระหนี้ ไถ่ถอนหลักประกัน หรือปฏิบัติผิดสัญญา หลักประกันที่เกี่ยวข้อง หรือหลักประกันที่ได้ให้ไว้เป็นประกัน ถูกบังคับหลักประกันหรือถูกยึดและหรือ/อายัด ไม่ว่าตามกฎหมายล้มละลาย หรือกฎหมายอื่นใดก็ตาม
      </p>

      {/* Section 6 - Legal Action */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 6.</b> กรณีที่ "ผู้กู้" ผิดนัดชำระหนี้เงินกู้ หรือดอกเบี้ยจากการผิดนัดชำระหนี้เงินกู้เกินกว่า 30 วัน "ผู้ให้กู้" ขอสงวนสิทธิในการดำเนินคดีตามกฎหมาย และฟ้องร้องคดีต่อศาลได้ทันที
      </p>

      {/* Section 7 - Right Assignment */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 7.</b> "ผู้กู้" ยินยอมให้ "ผู้ให้กู้" โอนสิทธิตามสัญญานี้ไม่ว่าทั้งหมด หรือแต่เพียงบางส่วนให้แก่บุคคลหรือนิติบุคคลอื่นใดได้ โดยส่งคำบอกกล่าวเป็นลายลักษณ์อักษรให้ "ผู้กู้" ทราบเป็นระยะเวลาไม่น้อยกว่า 30 (สามสิบ) วัน แต่ "ผู้กู้" ไม่มีสิทธิโอนสิทธิและหน้าที่ตามสัญญาให้สินเชื่อไม่ว่าทั้งหมดหรือบางส่วนให้แก่บุคคลหรือนิติบุคคลอื่นใดได้
      </p>
      ...
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        เพื่อวัตถุประสงค์ ในการจัดเก็บข้อมูล บริหาร วิเคราะห์ตรวจสอบ ทบทวน และป้องกันความเสี่ยงด้านสินเชื่อ ซึ่งเป็นการประมวลผลข้อมูลส่วนบุคคลบนฐานประโยชน์อันชอบธรรม
      </p>
      ...
      {/* Section 9 - Notice */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 9.</b> บรรดาหนังสือ จดหมายติดต่อ คำบอกกล่าวใดๆ ที่ "ผู้ให้กู้" ได้ส่งให้ "ผู้กู้" ตามที่อยู่ที่แจ้งไว้ตามสัญญาฉบับนี้ ไม่ว่าจะโดยส่งเองหรือส่งทางไปรษณีย์ลงทะเบียน หรือไม่ลงทะเบียน ให้ถือว่าได้ส่งให้แล้วโดยชอบ ทั้งนี้ โดยไม่ต้องคำนึงว่าจะมีผู้รับไว้หรือไม่ และแม้หากส่งให้ไม่ได้เพราะย้ายที่อยู่ หรือที่อยู่เปลี่ยนแปลงไป หรือถูกรื้อถอนไปโดยมิได้มีการแจ้งการย้าย การเปลี่ยนแปลง หรือการรื้อถอนนั้นเป็นลายลักษณ์อักษรให้ "ผู้ให้กู้" ทราบก็ดี หรือส่งให้ไม่ได้เพราะหาที่อยู่ตามที่ระบุไว้นั้นไม่พบก็ดี ให้ถือว่า "ผู้กู้" ได้รับและทราบหนังสือ จดหมาย หรือคำบอกกล่าวดังกล่าวแล้วโดยชอบ
      </p>

      {/* Section 10 - Waiver */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 10.</b> การล่าช้าหรือการไม่ใช้สิทธิใด ๆ ของ "ผู้ให้กู้" ตามข้อกำหนดหรือเงื่อนไขใด ๆ ของสัญญานี้หรือตามกฎหมาย ไม่ถือว่า "ผู้ให้กู้" สละสิทธิหรือให้ความยินยอมในการดำเนินการใด ๆ ตามที่ "ผู้ให้กู้" มีสิทธิแก่ "ผู้กู้" แต่ประการใด เว้นแต่ "ผู้ให้กู้" จะได้ทำเป็นหนังสืออย่างชัดแจ้งและการสละสิทธิเช่นว่านั้นให้มีผลเฉพาะสำหรับเหตุการณ์และวัตถุประสงค์นั้นเท่านั้น
      </p>
  ...
  const renderMgAddendum = () => (
    <>
      ...
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        สัญญาฉบับนี้ทำขึ้น ระหว่าง นาย/นาง/นางสาว {F('lender_first_name', 150, 'ชื่อผู้รับจำนอง')} เลขบัตรประชาชน {F('lender_id', 130)} ที่อยู่ตามบัตร {F('lender_address', 220)} เบอร์ {F('lender_phone', 100)} ซึ่งต่อไปในสัญญานี้จะเรียกว่า <b>"ผู้รับจำนอง"</b> ฝ่ายหนึ่ง กับ
      </p>
      ...
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 2.</b> ลูกหนี้ตกลงจำนองทรัพย์ที่ระบุข้างต้นไว้เป็นประกันหนี้ กับทั้งค่าอุปกรณ์ ดอกเบี้ย ค่าสินไหมทดแทนในการไม่ชำระหนี้ ค่าฤชาธรรมเนียมในการบังคับจำนอง ในหนี้เงินกู้ระหว่าง <b>"ผู้รับจำนอง"</b> กับลูกหนี้ มีกำหนดระยะเวลาก่อหนี้ {F('loan_term_months', 60)} เดือน ตามสัญญากู้ยืมเงินเลขที่ {F('loan_contract_number', 100, '___/2568')} ฉบับลงวันที่ {F('loan_contract_date', 120)} จำนวน {F('loan_amount', 120)} บาท ({F('loan_amount_text', 200)})
      </p>
      ...
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 12.</b> "ผู้จำนอง" ยินยอมให้ "ผู้รับจำนอง" โอนสิทธิจำนองตามสัญญาจำนองนี้ไม่ว่าทั้งหมด หรือแต่เพียงบางส่วน ให้แก่บุคคลหรือนิติบุคคลอื่นใดได้ โดยแจ้งล่วงหน้าเป็นลายลักษณ์อักษรให้ "ผู้จำนอง" ทราบล่วงหน้าเป็นระยะเวลาไม่น้อยกว่า 30 (สามสิบ) วัน แต่ "ผู้จำนอง" ไม่มีสิทธิโอนสิทธิและหน้าที่ตามสัญญาจำนองนี้ไม่ว่าทั้งหมดหรือบางส่วนให้แก่บุคคลหรือนิติบุคคลอื่นใดได้
      </p>

      {/* Section 13 - Data Disclosure */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 13.</b> "ผู้จำนอง" ตกลงและอนุญาตให้ "ผู้รับจำนอง" เปิดเผยข้อมูลใดๆ ที่ได้ให้ไว้แก่ "ผู้จำนอง" และ/หรือข้อมูลที่เกี่ยวข้องกับ "ผู้จำนอง" (ซึ่งมิใช่ข้อมูลที่ได้รับจากบริษัทข้อมูลเครดิต) เท่าที่จำเป็นต่อบริษัทในเครือของ "ผู้รับจำนอง" รวมถึงกรรมการ และลูกจ้างของ "ผู้รับจำนอง" เพื่อวัตถุประสงค์ในการจัดเก็บข้อมูล บริหาร วิเคราะห์ตรวจสอบ ทบทวน และป้องกันความเสี่ยงด้านสินเชื่อ
      </p>
      ...
      {/* Closing Statement */}
      <p style={{ ...S, fontSize: 'inherit', marginTop: 16 }}>
        สัญญาฉบับนี้ทำขึ้นเป็นสองฉบับ มีข้อความถูกต้องตรงกัน คู่สัญญาทั้งสองฝ่ายได้อ่านและเข้าใจข้อความในสัญญาโดยตลอดแล้ว เพื่อเป็นหลักฐานคู่สัญญาจึงลงลายมือชื่อไว้เป็นสำคัญต่อหน้าพยาน ณ วันเดือนปีที่ระบุไว้ข้างต้น และต่างยึดถือไว้ฝ่ายละฉบับ
      </p>
  ...
  const renderMgAppendix = () => (
    <>
      ...
      {/* Main Contract Reference */}
      <p style={{ ...S, fontSize: 'inherit', marginBottom: 14 }}>
        ได้ตกลงทำสัญญาแต่งตั้งนายหน้าจำนอง ฉบับลงวันที่ {F('main_contract_date', 150)} บริษัท โลนด์ ดีดี จำกัด (<b>"นายหน้า"</b>) ทะเบียนนิติบุคคลเลขที่ 0105566225836 โดย นาย วรวุฒิ กิตดิอุดม กรรมการผู้มีอำนาจ สำนักงานตั้งอยู่เลขที่ 87 ถนนสุวินทวงศ์ แขวงมีนบุรี เขตมีนบุรี กรุงเทพมหานคร โทรศัพท์ 081-6386966
      </p>
  ...
  const renderMgBroker = () => (
    <>
      ...
      {/* Parties - Company (Broker) */}
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        สัญญาฉบับนี้ทำขึ้น ระหว่าง บริษัท โลนด์ ดีดี จำกัด ทะเบียนนิติบุคคลเลขที่ {F('company_id', 130, '0105566225836')} โดย นาย {F('company_officer', 120, 'วรวุฒิ กิตดิอุดม')} กรรมการผู้มีอำนาจ สำนักงานตั้งอยู่เลขที่ 87 ถนนสุวินทวงศ์ แขวงมีนบุรี เขตมีนบุรี กรุงเทพมหานคร โทรศัพท์ {F('company_phone', 100, '081-6386966')} ซึ่งต่อไปในสัญญานี้จะเรียกว่า <b>"นายหน้า"</b> ฝ่ายหนึ่ง กับ
      </p>
      ...
      {/* Section 1 - Property Details */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 1.</b> ผู้ให้สัญญาเป็นเจ้าของกรรมสิทธิ์ <b>{F('property_type_full', 180, 'ห้องชุด/ที่ดินเปล่า/ที่ดินพร้อมสิ่งปลูกสร้าง')}</b> เลขที่ {F('address_no', 80)} โฉนดเลขที่ {F('deed_no', 100)} เลขที่ดิน {F('land_no', 80)} หน้าสำรวจ {F('survey_page', 80)} ตำบล {F('tambon', 100)} อำเภอ {F('amphoe', 100)} จังหวัด {F('province', 100)} เนื้อที่รวม {F('land_area', 130, 'ไร่/งาน/ตารางวา/ตารางเมตร')} ซึ่งต่อไปในสัญญานี้จะเรียกว่า <b>"ทรัพย์สิน"</b> ผู้ให้สัญญาประสงค์จะจำนองทรัพย์สินดังกล่าวกับบรรดาสิ่งปลูกสร้างต่างๆ ที่มีอยู่ในที่ดินรายนี้ขณะนี้หรือที่จะมีขึ้นต่อไปในภายหน้าในที่ดินรายนี้ทั้งสิ้น เพื่อเป็นประกันหนี้สินของ {selectedVersion === 3 ? <>บจก./หจก. {F('borrower_company', 150)}</> : selectedVersion === 2 ? <>นาย/นาง/นางสาว {F('borrower_name', 120)} และ นาย/นาง/นางสาว {F('borrower_name2', 120)}</> : <>นาย/นาง/นางสาว {F('borrower_name', 150)}</>} ในราคาประมาณ {F('loan_amount', 120)} บาท ( {F('loan_amount_text', 160)} )
      </p>

      {/* Section 2 - Broker Appointment */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 2.</b> "ผู้ให้สัญญา" แต่งตั้งให้ "นายหน้า" เป็นผู้ติดต่อ จัดหา ชี้ช่อง และจัดการให้ได้เข้าทำสัญญากับนายทุนผู้รับจำนอง โดยหาก "ผู้ให้สัญญา" ได้เข้าทำสัญญาจำนองกับนายทุนผู้รับจำนองแล้ว จะดำเนินการลงนามในเอกสารแนบท้ายด้วย
      </p>

      {/* Section 3 - Commission Rate */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 3.</b> เมื่อนายทุนผู้รับจำนองเข้าทำสัญญาจำนองโดยจดทะเบียนจำนองกันที่สำนักงานที่ดินและได้รับชำระเงินจากการจำนองเรียบร้อยแล้วภายในกำหนดระยะเวลาตามสัญญานี้ "ผู้ให้สัญญา" ตกลงชำระค่านายหน้าให้แก่ "นายหน้า" <b>ทันที</b> ในอัตราค่านายหน้าร้อยละ {F('broker_rate', 80)} ( {F('broker_rate_text', 100)} ) ของวงเงินจำนอง สำหรับวงเงินต่ำกว่า 1,000,000 บาท (หนึ่งล้านบาทถ้วน) คิดอัตราค่านายหน้าขั้นต่ำ 50,000 บาท (ห้าหมื่นบาทถ้วน) ทั้งนี้ "นายหน้า" ขอสงวนสิทธิในการคิดค่าบริการเพิ่มเติมตามที่ปรากฎในเอกสารแนบท้ายภายหลังที่ "ผู้ให้สัญญา" ได้เข้าทำสัญญาจำนองกับนายทุนผู้รับจำนองสำเร็จแล้ว
      </p>

      {/* Section 3.1 - Payment Details */}
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        <b>3.1.</b> ผู้ให้สัญญาตกลงชำระค่านายหน้าด้วยวิธีการโอนเงินไปยังบัญชีของนายหน้า ซึ่งมีรายละเอียดดังนี้ ชื่อธนาคาร : {F('bank_name', 120, 'ไทยพาณิชย์')}<br />
        ชื่อบัญชี : {F('account_name', 200, 'บริษัท โลนด์ ดีดี จำกัด')}<br />
        สาขา : {F('branch_name', 150, 'รามคำแหง (สัมมากร)')}<br />
        หมายเลขบัญชี : {F('account_number', 150, '136-2707297')}
      </p>
      ...
      {/* Section 5 - Registration & Completion */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 5.</b> "ผู้ให้สัญญา" ตกลงเข้าทำสัญญาจำนองโดยจดทะเบียนจำนองกันที่สำนักงานที่ดินภายใน 30 (สามสิบ) วัน นับจากวันทำสัญญา ทั้งนี้ ให้ถือว่า "นายหน้า" ได้ทำหน้าที่สมบูรณ์ตามสัญญาแล้วเมื่อพ้นกำหนดระยะเวลาดังกล่าว และยินยอมชำระค่านายหน้าให้แก่ "นายหน้า" ตามข้อ 3.
      </p>

      {/* Section 5.1 */}
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        <b>5.1.</b> ค่าธรรมเนียมและค่าใช้จ่ายทั้งสิ้นในการจดทะเบียนจำนอง ค่าไถ่ถอน ค่าภาษีที่ดินและสิ่งปลูกสร้างรวมไปถึง ค่าฤชาธรรมเนียมใดๆ ที่สำนักงานที่ดินเรียกเก็บ "ผู้ให้สัญญา" จะเป็นผู้เสียเองทั้งสิ้น
      </p>

      {/* Section 5.2 */}
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        <b>5.2.</b> ในกรณีแจ้งไถ่ถอน "ผู้ให้สัญญา" จะแจ้งให้ "นายหน้า" ทราบล่วงหน้าไม่ต่ำกว่า 15 ( สิบห้า ) วัน และมีค่าใช้จ่ายในการดำเนินการไถ่ถอนเป็นจำนวนเงิน {F('redemption_fee', 100, '5,000')} บาท ( ห้าพันบาทถ้วน ) กรณีทรัพย์สินที่ตั้งอยู่ต่างจังหวัดจะไม่รวมค่าเดินทางไปและกลับ ซึ่งทาง "ผู้ให้สัญญา" จะเป็นผู้ชำระให้แก่ บริษัท โลนด์ ดีดี จำกัด
      </p>

      {/* Section 5.3 */}
      <p style={{ ...S, textIndent: 40, fontSize: 'inherit' }}>
        <b>5.3.</b> ในกรณีที่ "ผู้ให้สัญญา" ไม่ทราบราคาประเมินทรัพย์สินและต้องการให้ "นายหน้า" เป็นผู้ประเมินราคาทรัพย์สิน "ผู้ให้สัญญา" ตกลงชำระค่าประเมินจำนวน {F('appraisal_fee', 80)} บาท ( ) และจะส่งโฉนดที่ดินมาให้ "นายหน้า" เพื่อประเมินราคาทรัพย์สิน
      </p>

      {/* Section 6 - Exclusivity */}
      <p style={{ ...S, fontSize: 'inherit' }}>
        <b>ข้อ 6.</b> ในระหว่างที่สัญญานี้ยังมีผลบังคับใช้ "ผู้ให้สัญญา" ตกลงว่าจะไม่ทำสัญญาแต่งตั้งนายหน้า หรือตัวแทนแต่เพียงผู้เดียวกับบุคคลหรือนิติบุคคลอื่นสำหรับการจำนองทรัพย์สินดังกล่าว นอกจากนี้ "ผู้ให้สัญญา" ตกลงว่าจะไม่บอกเลิกสัญญาฉบับนี้ก่อนครบกำหนดเวลา ไม่ว่าด้วยเหตุผลใด และจะไม่ดำเนินการจำนอง ขาย ให้เช่า หรือขายฝากทรัพย์สินดังกล่าวแก่บุคคลหรือนิติบุคคลอื่น หากมีบุคคลหรือนิติบุคคลอื่นติดต่อมาเพื่อเป็นนายหน้าหรือตัวแทนในการหานายทุนผู้รับจำนอง "ผู้ให้สัญญา" ตกลงให้เป็นหน้าที่ของ "นายหน้า" ตามสัญญาฉบับนี้ในการดำเนินการจัดหานายทุน และจะชำระค่านายหน้าให้แก่ "นายหน้า" ตามเงื่อนไขที่ระบุไว้ข้อ 3 ของสัญญานี้
      </p>
  ...
  return (
    ...
    >
      ...
      >
        <div className="doc-modal-toolbar-left" style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
          <button
            onClick={onClose}
            style={{
              padding: '8px 14px',
          ...
          >
            <i className="fas fa-arrow-left"></i> <span className="doc-btn-label">ย้อนกลับ</span>
          </button>
          <div className="doc-modal-title" style={{ fontSize: 16, fontWeight: 'bold', color: TEMPLATES[templateType]?.color }}>
          ...
          <div className="doc-modal-page-badge" style={{
            fontSize: 12,
            color: '#6b7280',
            backgroundColor: '#f3f4f6',
            padding: '4px 10px',
        ...
        <div className="doc-modal-toolbar-right" style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
          ...
          >
            ...
            <span className="doc-btn-label">{saving ? 'กำลังบันทึก...' : 'บันทึกเอกสาร'}</span>
          </button>
          <button
            onClick={handlePrint}
            disabled={printing}
          ...
          >
            ...
            <span className="doc-btn-label">{printing ? 'กำลังพิมพ์...' : 'พิมพ์'}</span>
          </button>
          <button
          ...
          >
            ...
            <span className="doc-btn-label">โหลด .doc</span>
          </button>
        </div>
      </div>
