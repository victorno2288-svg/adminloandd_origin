...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2026 at 04:31 AM
...
CREATE TABLE `agents` (
  ...
  `payment_slip` varchar(500) DEFAULT NULL COMMENT 'สลิปการรับเงินค่านายหน้า (path ไฟล์)',
  `bank_book_file` varchar(500) DEFAULT NULL COMMENT 'หน้าสมุดบัญชีนายหน้า (sync จากฝ่ายนิติกรรม)',
...
INSERT INTO `agents` (`id`, `agent_code`, `full_name`, `nickname`, `phone`, `email`, `line_id`, `facebook`, `national_id`, `bank_name`, `bank_account_number`, `bank_account_name`, `area`, `commission_rate`, `id_card_image`, `contract_file`, `payment_slip`, `bank_book_file`, `contract_date`, `status`, `created_at`, `updated_at`, `date_of_birth`, `national_id_expiry`, `address`, `house_registration_image`) VALUES
(1, 'LDD0001', 'ง่วง', 'ไม่บอก', '00000000', 'loandd02@gmail.com', '@kkk', NULL, NULL, NULL, NULL, NULL, NULL, 90.00, 'uploads/id-cards/1771467780103-403.jpg', NULL, NULL, NULL, NULL, 'active', '2026-02-18 04:20:15', '2026-02-23 10:27:33', NULL, NULL, NULL, NULL),
(2, 'LDD0002', 'ลอง', 'ระบบ', '0956504157', 'aaaa@hotmail.com', 'fffff', NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, NULL, NULL, NULL, NULL, 'active', '2026-02-23 02:27:41', '2026-03-24 03:02:53', NULL, NULL, NULL, NULL),
(5, 'AGT0001', 'นอน', 'ลอง', '09998788', 'lo@gmail.com', '@mager', NULL, NULL, NULL, NULL, NULL, NULL, 0.00, 'uploads/id-cards/1774320008355-378.jpg', NULL, NULL, NULL, NULL, 'active', '2026-02-24 08:21:27', '2026-03-24 02:40:08', NULL, NULL, '222 หมู่ 4 ถนนกะทา ตำบลบางกะปิ อำเภอบางกะปิ กรุงเทพมหานคร', 'uploads/id-cards/1774320008366-118.jpg');
...
CREATE TABLE `auction_bids` (
  ...
  `refund_status` enum('pending','refunded','winner') NOT NULL DEFAULT 'pending',
...
CREATE TABLE `auction_transactions` (
  ...
  `auction_status` enum('pending','auctioned','auction_completed','cancelled') NOT NULL DEFAULT 'pending',
...
INSERT INTO `auction_transactions` (`id`, `case_id`, `investor_id`, `investor_name`, `investor_code`, `investor_phone`, `investor_type`, `property_value`, `selling_pledge_amount`, `interest_rate`, `auction_land_area`, `contract_years`, `house_reg_book`, `house_reg_book_legal`, `name_change_doc`, `divorce_doc`, `spouse_consent_doc`, `spouse_id_card`, `spouse_reg_copy`, `marriage_cert`, `spouse_name_change_doc`, `borrower_id_card`, `single_cert`, `death_cert`, `will_court_doc`, `testator_house_reg`, `is_cancelled`, `auction_status`, `recorded_by`, `recorded_at`, `created_at`, `updated_at`, `sale_type`, `bank_name`, `bank_account_no`, `bank_account_name`, `transfer_slip`, `land_transfer_date`, `land_transfer_time`, `land_transfer_location`, `land_transfer_note`, `bank_book_file`) VALUES
(1, 1, 3, 'พี่เป้', 'CAP0001', '000000000', 'individual', 50000.00, 50000.00, 40.00, '123456', 2004, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'cancelled', 'ทาย', '2026-02-18 02:32:00', '2026-02-18 16:30:12', '2026-02-20 13:58:54', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 2, 4, 'มะเมียมะมะมะเมีย', 'CAP0002', '1245677874', 'corporate', 7777.00, 8888.00, 6666.00, '5555', 2998, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'auctioned', 'f', NULL, '2026-02-22 12:48:29', '2026-02-25 18:30:44', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 4, 4, 'มะเมียมะมะมะเมีย', 'CAP0002', '1245677874', NULL, 6666666.00, 66566.00, 0.50, '777777', 9999, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'auctioned', 'g', NULL, '2026-02-24 14:08:19', '2026-02-24 14:08:55', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'auctioned', NULL, NULL, '2026-02-24 14:38:06', '2026-02-24 15:01:01', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'auctioned', NULL, NULL, '2026-02-24 20:09:43', '2026-02-24 20:09:43', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
CREATE TABLE `investors` (
  ...
  `deposit_slip` varchar(500) DEFAULT NULL COMMENT 'สลิปเงินมัดจำ 1% จากนายทุน (path ไฟล์)',
...
CREATE TABLE `legal_transactions` (
  ...
  `agent_payment_slip` varchar(500) DEFAULT NULL COMMENT 'สลิปค่านายหน้า (อัพโหลดโดยฝ่ายนิติกรรม)',
  `agent_bank_book` varchar(500) DEFAULT NULL COMMENT 'หน้าสมุดบัญชีนายหน้า (อัพโหลด+OCR โดยฝ่ายนิติกรรม)',
...
CREATE TABLE `loan_requests` (
  ...
  `bank_account_name` varchar(255) DEFAULT NULL COMMENT 'ชื่อบัญชีธนาคารลูกหนี้',
...
(148, 'internal', 30, 9, NULL, 'all', NULL, NULL, NULL, NULL, 'นิติกรรมเสร็จสิ้น', 'เคส LDD0003 (ภัทร) ทำธุรกรรมเรียบร้อยแล้ว', NULL, 'legal_completed', 0, 0, NULL, NULL, '/legal/edit/9', 1, '2026-03-23 15:51:50'),
(149, 'internal', 30, 9, NULL, 'all', NULL, NULL, NULL, NULL, 'นิติกรรมเสร็จสิ้น', 'เคส LDD0003 (ภัทร) ทำธุรกรรมเรียบร้อยแล้ว', NULL, 'legal_completed', 0, 0, NULL, NULL, '/legal/edit/9', 1, '2026-03-23 15:52:03'),
(150, 'internal', 30, 9, NULL, 'legal', NULL, NULL, NULL, NULL, '📅 นัดวันโอนแล้ว — แจ้งฝ่ายนิติกรรม', 'ฝ่ายขายกำหนดวันโอนกรรมสิทธิ์เคส LDD0003 (ภัทร) แล้ว — 23 กุมภาพันธ์ 2569 · 09.00 · โคราช', NULL, 'transaction_scheduled_to_legal', 0, 0, NULL, NULL, '/legal/edit/9', 1, '2026-03-25 09:54:18'),
(151, 'internal', 30, 9, NULL, 'all', NULL, NULL, NULL, NULL, 'นิติกรรมเสร็จสิ้น', 'เคส LDD0003 (ภัทร) ทำธุรกรรมเรียบร้อยแล้ว', NULL, 'legal_completed', 0, 0, NULL, NULL, '/legal/edit/9', 1, '2026-03-25 09:54:18'),
(152, 'internal', 30, 9, NULL, 'legal', NULL, NULL, NULL, NULL, '📅 นัดวันโอนแล้ว — แจ้งฝ่ายนิติกรรม', 'ฝ่ายขายกำหนดวันโอนกรรมสิทธิ์เคส LDD0003 (ภัทร) แล้ว — 23 กุมภาพันธ์ 2569 · 09.00 · โคราช', NULL, 'transaction_scheduled_to_legal', 0, 0, NULL, NULL, '/legal/edit/9', 1, '2026-03-25 09:54:55'),
(153, 'internal', 30, 9, NULL, 'all', NULL, NULL, NULL, NULL, 'นิติกรรมเสร็จสิ้น', 'เคส LDD0003 (ภัทร) ทำธุรกรรมเรียบร้อยแล้ว', NULL, 'legal_completed', 0, 0, NULL, NULL, '/legal/edit/9', 1, '2026-03-25 09:54:55'),
(154, 'internal', 33, NULL, NULL, 'all', NULL, NULL, NULL, NULL, 'รอชำระค่าประเมิน', 'เคส LDD0004 (นางภิรญา แสงศิริมล) รอลูกค้าชำระค่าประเมิน', NULL, 'awaiting_appraisal_fee', 0, 0, NULL, NULL, '/sales/edit/33', 1, '2026-03-25 10:51:49'),
(155, 'internal', 33, NULL, NULL, 'all', NULL, NULL, NULL, NULL, 'ประเมินผ่าน — รอพิจารณาอนุมัติ', 'เคส LDD0004 (นางภิรญา แสงศิริมล) ผ่านการประเมินแล้ว รอพิจารณาอนุมัติวงเงิน', NULL, 'appraisal_passed', 0, 0, NULL, NULL, '/sales/edit/33', 1, '2026-03-25 10:51:49'),
(156, 'internal', 33, NULL, NULL, 'all', NULL, NULL, NULL, NULL, 'รอชำระค่าประเมิน', 'เคส LDD0004 (นางภิรญา แสงศิริมล) รอลูกค้าชำระค่าประเมิน', NULL, 'awaiting_appraisal_fee', 0, 0, NULL, NULL, '/sales/edit/33', 1, '2026-03-25 16:34:12'),
(157, 'internal', 33, NULL, NULL, 'all', NULL, NULL, NULL, NULL, 'ประเมินผ่าน — รอพิจารณาอนุมัติ', 'เคส LDD0004 (นางภิรญา แสงศิริมล) ผ่านการประเมินแล้ว รอพิจารณาอนุมัติวงเงิน', NULL, 'appraisal_passed', 0, 0, NULL, NULL, '/sales/edit/33', 1, '2026-03-25 16:34:12'),
(158, 'internal', 33, NULL, NULL, 'all', NULL, NULL, NULL, NULL, 'ประเมินผ่าน — รอพิจารณาอนุมัติ', 'เคส LDD0004 (นางปริญา แสงศิริมล) ผ่านการประเมินแล้ว รอพิจารณาอนุมัติวงเงิน', NULL, 'appraisal_passed', 0, 0, NULL, NULL, '/sales/edit/33', 1, '2026-03-25 16:41:48'),
(159, 'internal', 33, NULL, NULL, 'all', NULL, NULL, NULL, NULL, 'รอชำระค่าประเมิน', 'เคส LDD0004 (นางปริญา แสงศิริมล) รอลูกค้าชำระค่าประเมิน', NULL, 'awaiting_appraisal_fee', 0, 0, NULL, NULL, '/sales/edit/33', 1, '2026-03-25 16:41:48'),
(160, 'internal', 33, NULL, NULL, 'sales', NULL, NULL, NULL, NULL, '📋 ตารางวงเงินพร้อมแล้ว', 'ฝ่ายอนุมัติสินเชื่ออัพโหลดตารางวงเงินของ LDD0004 (นางปริญา แสงศิริมล) เรียบร้อยแล้ว', NULL, 'credit_table_to_sales', 0, 0, NULL, NULL, '/sales/edit/33', 1, '2026-03-25 16:44:24'),
(161, 'internal', 33, NULL, NULL, 'appraisal', NULL, NULL, NULL, NULL, '📋 ตารางวงเงินพร้อมแล้ว — แจ้งฝ่ายประเมิน', 'ฝ่ายอนุมัติสินเชื่ออัพโหลดตารางวงเงินของ LDD0004 (นางปริญา แสงศิริมล) เรียบร้อยแล้ว', NULL, 'credit_table_to_appraisal', 0, 0, NULL, NULL, '/appraisal/edit/33', 1, '2026-03-25 16:44:24'),
(162, 'internal', 33, NULL, NULL, 'all', NULL, NULL, NULL, NULL, 'อนุมัติวงเงินแล้ว', 'เคส LDD0004 (นางปริญา แสงศิริมล) อนุมัติวงเงิน  แล้ว', NULL, 'credit_approved', 0, 0, NULL, NULL, '/sales/edit/33', 1, '2026-03-25 16:44:47'),
(163, 'internal', 33, 10, NULL, 'all', NULL, NULL, NULL, NULL, 'เคสใหม่ — รอประเมิน', 'เคสใหม่ LDD0004 (นางปริญา แสงศิริมล) ถูกสร้างแล้ว กรุณาดำเนินการประเมิน', NULL, 'reviewing', 0, 0, NULL, NULL, '/sales/case/edit/10', 1, '2026-03-25 16:46:14'),
(164, 'internal', 33, 10, NULL, 'legal', NULL, NULL, NULL, NULL, '📅 นัดวันโอนแล้ว — แจ้งฝ่ายนิติกรรม', 'ฝ่ายขายกำหนดวันโอนกรรมสิทธิ์เคส LDD0004 (นางปริญา แสงศิริมล) แล้ว — 26 มีนาคม 2569 · 11.00 น. · สำนักงานที่ดินกรุงเทพมหานคร สาขาดอนเมือง', NULL, 'transaction_scheduled_to_legal', 0, 0, NULL, NULL, '/legal/edit/10', 1, '2026-03-25 16:46:47'),
(165, 'internal', 33, 10, NULL, 'all', NULL, NULL, NULL, NULL, 'นัดทำธุรกรรมแล้ว', 'เคส LDD0004 (นางปริญา แสงศิริมล) นัดทำธุรกรรม วันที่ 2026-03-26', NULL, 'legal_scheduled', 0, 0, NULL, NULL, '/legal/edit/10', 1, '2026-03-25 16:48:31'),
...
--
-- Error reading structure for table loandd_db.slip_verifications: #1932 - Table &#039;loandd_db.slip_verifications&#039; doesn&#039;t exist in engine
-- Error reading data for table loandd_db.slip_verifications: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `loandd_db`.`slip_verifications`&#039; at line 1
